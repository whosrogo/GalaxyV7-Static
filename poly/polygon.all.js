(() => {
  var e = {
          ...
          (e.Proxy("window.open", {
            apply(t) {
              (t.args[0] && (t.args[0] = (0, a.Oy)(t.args[0], e.meta)),
                ...
                "_parent" === t.args[1] &&
                  (t.args[1] = e.meta.parentFrameName));
              let r = t.call();
      ...
      6286: function (e, t, r) {
        ...
        function a(e, t) {
          (e.Trap("PerformanceEntry.prototype.name", {
            get(e) {
              let t = e.get();
              return t && t.startsWith(location.origin + i.$W.prefix)
                ? (0, n.v2)(t)
                : t;
            },
          }),
        ...
        function n(e, t) {
          let r = {
            ...
            defineProperty: (t, r, n) => (
              t.setItem(e.url.host + "@" + r, n.value),
              !0
            ),
          };
          t.localStorage;
      ...
      582: function (e, t, r) {
        (r.r(t),
          r.d(t, { argdbg: () => a, default: () => s, enabled: () => i }));
        var n = r(37);
      ...
      581: function (e, t, r) {
        (r.r(t),
          r.d(t, { createWrapFn: () => o, default: () => c, order: () => l }));
        var n = r(1323),
          i = r(2794),
          a = r(37),
          s = r(591);
        ...
        function c(e, t) {
          (Object.defineProperty(t, a.$W.globals.wrapfn, {
            ...
            Object.defineProperty(
              t.Object.prototype,
              a.$W.globals.wrappropertybase + "location",
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              a.$W.globals.wrappropertybase + "parent",
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              a.$W.globals.wrappropertybase + "top",
              {
                get: function () {
            ...
            Object.defineProperty(
              t.Object.prototype,
              a.$W.globals.wrappropertybase + "eval",
              {
                get: function () {
            ...
            (t.$cinnaitize = function (e) {
              return (
                location,
                n.iswindow && t.top,
                "string" == typeof e && e.includes("poly"),
            ...
            let e = await (0, a.P2)("$cinnabar", 1, {
              upgrade(e) {
                (e.objectStoreNames.contains("config") ||
                  ...
                  e.objectStoreNames.contains("cookies") ||
  ...
  `,
          ...
          getCookies(e, t) {
            ...
            for (let a of n) {
              ...
              (!a.secure || "https:" === e.protocol) &&
                ...
                (!a.domain.startsWith(".") ||
                  e.hostname.endsWith(a.domain.slice(1))) &&
                i.push(a);
            }
      ...
      2393: function (e, t, r) {
        ...
        let s = [
          ...
          {
            fn: (e, t) =>
              e.startsWith("blob:") ? (0, a.$n)(e) : (0, a.Oy)(e, t),
            src: ["video", "audio"],
          },
...
${l}`;
      ...
      1561: function (e, t, r) {
        ...
        async function d() {
          n = new Uint8Array(
            await fetch(a.$W.files.wasm).then((e) => e.arrayBuffer()),
          );
        }
        self.WASM &&
...
self.WASM = '${r}';`),
            ...
            for (let [e, t] of [...o.searchParams.entries()]) {
              switch (e) {
                ...
                default:
                  (f.warn(
                    `${o.href} extraneous query parameter ${e}. Assuming <form> element`,
                  ),
                    (d[e] = t));
              }
            ...
            (await (0, a.rj)(
              h.toString(),
              e.referrer ? (0, s.v2)(e.referrer) : null,
              x,
            ),
        ...
        async function y(e, t, r, n, o, l, d, h, p, f, m) {
          ...
          if (
            (S &&
              v["referrer-policy"] &&
              m &&
              (await (0, a.pL)(e.href, v["referrer-policy"], m)),
            g(l))
          ) {
          ...
          (l.body && !g(l) && (y = await b(l, t, n, r, d)),
            "text/event-stream" === v.accept &&
              (v["content-type"] = "text/event-stream"),
      ...
      236: function (e, t, r) {
        ...
        class p {
          ...
          async sendMessage(e, t) {
            ...
            return (
              o.call(this.port, { message: e, port: r.port2 }, n),
              await i
            );
          }
        }
        ...
        class g {
          constructor(e, t = {}) {
            ...
            ((this.options = t),
              ...
              (this.tokenizer = new (null != (s = t.Tokenizer) ? s : n.A)(
                this.options,
                this,
              )),
      ...
      5645: function (e, t, r) {
        ...
        class p {
          ...
          isTagStartChar(e) {
            return this.xmlMode
              ? !d(e)
              : (e >= s.LowerA && e <= s.LowerZ) ||
                  (e >= s.UpperA && e <= s.UpperZ);
          }
          startSpecial(e, t) {
            ((this.isSpecial = !0),
            ...
            e === t || (!this.decodeEntities && this.fastForwardTo(t))
              ? (this.cbs.onattribdata(this.sectionStart, this.index),
                ...
                this.cbs.onattribend(
                  t === s.DoubleQuote ? l.Double : l.Single,
                  this.index + 1,
                ),
                (this.state = o.BeforeAttributeName))
              : this.decodeEntities && e === s.Amp && this.startEntity();
          ...
          cleanup() {
            this.running &&
              this.sectionStart !== this.index &&
              (this.state === o.Text ||
              (this.state === o.InSpecialTag && 0 === this.sequenceIndex)
                ? (this.cbs.ontext(this.sectionStart, this.index),
                  (this.sectionStart = this.index))
                : (this.state === o.InAttributeValueDq ||
                    this.state === o.InAttributeValueSq ||
        ...
        function l() {
          return (
            (null === o || 0 === o.byteLength) &&
              (o = new Uint8Array(n.memory.buffer)),
            o
          );
        }
        function c(e, t) {
